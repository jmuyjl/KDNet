...
class CornerNet_Loss(nn.Module):
    ...
    def forward(self, outs, targets):
        ...
        # return loss.unsqueeze(0), focal_loss, pull_loss, push_loss, off_loss
        return loss.unsqueeze(0), (focal_loss / len(tl_heats)).unsqueeze(0), (pull_loss / len(tl_heats)).unsqueeze(0), (push_loss / len(tl_heats)).unsqueeze(0), (off_loss / len(tl_heats)).unsqueeze(0)
